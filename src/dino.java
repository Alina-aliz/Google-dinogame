...
public class dino {
    ...
    public dino (int x, int y){
        try {
           dinoStand = ImageIO.read(dino.class.getResource("/assets/dinoStand.jpeg"));
        } catch (IOException ex) {
        }
        try {
           dinoRun1 = ImageIO.read(dino.class.getResource("/assets/dinoRun1.jpeg"));
        } catch (IOException ex) {
        }
        try {
           dinoRun2 = ImageIO.read(dino.class.getResource("/assets/dinoRun2.jpeg"));
        } catch (IOException ex) {
        }
        try {
           dinoDead = ImageIO.read(dino.class.getResource("/assets/dinoDead.jpeg"));
        } catch (IOException ex) {
        }
        try {
           Duckdino1 = ImageIO.read(dino.class.getResource("/assets/duckDino1.jpeg"));
        } catch (IOException ex) {
        }
        try {
           Duckdino2 = ImageIO.read(dino.class.getResource("/assets/duckDino2.jpeg"));
        } catch (IOException ex) {
        }
